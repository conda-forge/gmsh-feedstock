...
pixi add gmsh python-gmsh
# for installing globally
pixi global install gmsh python-gmsh
```
...
It is possible to list all of the versions of `gmsh` available on your platform:
...
```
pixi search gmsh --channel conda-forge
```
